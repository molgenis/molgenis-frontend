<template>
  <button
    ...
    class="m-2 btn-sm float-right text-nowrap shopping-button">
    <font-awesome-icon size="xs" v-if="isSelected" icon="minus"></font-awesome-icon>
    <font-awesome-icon size="xs" v-else icon="plus"></font-awesome-icon>
