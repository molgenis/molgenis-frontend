...
describe('actions', () => {
  ...
  describe('fetchGroups', () => {
    it('should fetch a list of groups and commit them to the store', done => {
      ...
      td.when(get('/api/identities/group')).thenResolve(groupList)
    ...
    it('should commit any errors to the store', done => {
      ...
      const get = td.function('api.get')
      td.when(get('/api/identities/group')).thenReject(error)
      td.replace(api, 'get', get)
  ...
  describe('fetchGroupRoles', () => {
    ...
    it('should fetch a list of groups roles for a given group and commit them to the store', done => {
      ...
      const get = td.function('api.get')
      td.when(get('/api/identities/group/my-group/role')).thenResolve(roles)
      td.replace(api, 'get', get)
    ...
    it('should commit any errors to the store', done => {
      ...
      td.when(get('/api/identities/group/error-group/role')).thenReject(error)
      td.replace(api, 'get', get)
  ...
  describe('tempFetchUsers', () => {
    it('should fetch a list of all users ( until we have a invite system)', done => {
      ...
      const get = td.function('api.get')
      td.when(get('/api/identities/user')).thenResolve(users)
      td.replace(api, 'get', get)
    ...
    it('should commit any errors to the store', done => {
      ...
      td.when(get('/api/identities/user')).thenReject(error)
      td.replace(api, 'get', get)
  ...
  describe('fetchGroupMembers', () => {
    ...
    it('should fetch a list of groups roles for a given group and commit them to the store', done => {
      ...
      const get = td.function('api.get')
      td.when(get('/api/identities/group/my-group/member')).thenResolve(members)
      td.replace(api, 'get', get)
    ...
    it('should commit any errors to the store', done => {
      ...
      td.when(get('/api/identities/group/error-group/member')).thenReject(error)
      td.replace(api, 'get', get)
  ...
  describe('fetchGroupPermissions', () => {
    ...
    it('should fetch a list of groups roles for a given group and commit them to the store', done => {
      ...
      const get = td.function('api.get')
      td.when(get('/api/identities/group/my-group/permission')).thenResolve(groupPermissions)
      td.replace(api, 'get', get)
    ...
    it('should commit any errors to the store', done => {
      ...
      td.when(get('/api/identities/group/error-group/permission')).thenReject(error)
      td.replace(api, 'get', get)
  ...
  describe('createGroup', () => {
    it('should create a group and displays toast', done => {
      ...
      td.when(post('/api/identities/group', generatedPayload)).thenResolve(response)
    ...
    it('should commit any errors to the store', done => {
      ...
      const post = td.function('api.post')
      td.when(post('/api/identities/group', generatedPayload)).thenReject(error)
      td.replace(api, 'post', post)
  ...
  describe('addMember', () => {
    ...
    it('should add a member to the group and displays toast', done => {
      ...
      const post = td.function('api.post')
      td.when(post('/api/identities/group/my-group/member', generatedPayload)).thenResolve()
      td.replace(api, 'post', post)
    ...
    it('should commit any errors to the store', done => {
      ...
      const post = td.function('api.post')
      td.when(post('/api/identities/group/my-group/member', generatedPayload)).thenReject(error)
      td.replace(api, 'post', post)
  ...
  describe('removeMember', () => {
    ...
    it('should remove a member from the group and displays toast', done => {
      ...
      td.when(delete_('/api/identities/group/my-group/member/user1')).thenResolve()
    ...
    it('should commit any errors to the store', done => {
      ...
      const delete_ = td.function('api.delete_')
      td.when(delete_('/api/identities/group/my-group/member/user1')).thenReject(error)
      td.replace(api, 'delete_', delete_)
  ...
  describe('updateMember', () => {
    ...
    it('should updateMember a member from the group and displays toast', done => {
      ...
      td.when(put('/api/identities/group/my-group/member/user1', generatedPayload)).thenResolve()
    ...
    it('should commit any errors to the store', done => {
      ...
      const put = td.function('api.put')
      td.when(put('/api/identities/group/my-group/member/user1', generatedPayload)).thenReject(error)
      td.replace(api, 'put', put)
  ...
  describe('deleteGroup', () => {
    ...
    it('should delete group and display toast', done => {
      const delete_ = td.function('api.delete_')
      td.when(delete_('/api/identities/group/my-group')).thenResolve()
      td.replace(api, 'delete_', delete_)
    ...
    it('should commit any errors to the store', done => {
      ...
      td.when(delete_('/api/identities/group/my-group')).thenReject(error)
      td.replace(api, 'delete_', delete_)
